...
function OpenLocation(n) {
    isLoadPopupLocation ? $(".locationbox-v2").length > 0 ? LoadPopupLocationV2() : LoadPopupLocation() : ($(".locationbox-v2").length > 0 ? (callFirstLoadPopup(), clearPopupLocation($(".locationbox-v2").is(":visible")), $(".locationbox-v2").toggle()) : $(".locationbox").toggle(), $(".locationbox__overlay").toggle(), $("#lc_pop--sugg").remove(), $("html,body").toggleClass("over-flow"));
    n ? ($(".locationbox").addClass("atdetailpage"), $("#lc_title").addClass("hide"), $(".box-re").removeClass("hide"), $("#hdLocationWardId").val() == 0 && ($(".locationbox__popup .accept .btnConfirm").addClass("disabled"), $(".locationbox__popup .accept .btnConfirm").html("Má»i báº¡n chá»n Ä‘áº§y Ä‘á»§ Ä‘á»‹a chá»‰"))) : ($(".locationbox").removeClass("atdetailpage"), $("#lc_title").removeClass("hide"), $(".box-re").addClass("hide"), $(".locationbox__popup .accept .btnConfirm").removeClass("disabled"), $(".locationbox__popup .accept .btnConfirm").html("XĂ¡c nháº­n"), $(".header__address").toggleClass("active"))
}
        ...
        success: function(n) {
            if (n != "" && n.status == 1) {
                if (typeof extParams != "undefined" && (isCallFastDeli && parseInt(document.cateID) > 0 && extParams !== undefined || extParams.indexOf("fast") >= 0)) {
                    ...
                    history.pushState({}, "", n);
                    reloadPage()
                } else typeof searchQuery != "undefined" && isCallFastDeliSearch && searchQuery !== undefined && searchQuery.CateID > 0 && (location.hash = $(".extend-filter a.fastdeli").hasClass("active") == !1 && getLocationCustomer().wardID > 0 ? "#fastdeli&c=" + searchQuery.CateID : "");
...
function stringToSlug(n) {
    return n = n.replace(/Ă |Ă¡|áº¡|áº£|Ă£|Ă¢|áº§|áº¥|áº­|áº©|áº«|Äƒ|áº±|áº¯|áº·|áº³|áºµ/g, "a"), n = n.replace(/Ă¨|Ă©|áº¹|áº»|áº½|Ăª|á»|áº¿|á»‡|á»ƒ|á»…/g, "e"), n = n.replace(/Ă¬|Ă­|á»‹|á»‰|Ä©/g, "i"), n = n.replace(/Ă²|Ă³|á»|á»|Ăµ|Ă´|á»“|á»‘|á»™|á»•|á»—|Æ¡|á»|á»›|á»£|á»Ÿ|á»¡/g, "o"), n = n.replace(/Ă¹|Ăº|á»¥|á»§|Å©|Æ°|á»«|á»©|á»±|á»­|á»¯/g, "u"), n = n.replace(/á»³|Ă½|á»µ|á»·|á»¹/g, "y"), n = n.replace(/Ä‘/g, "d"), n = n.replace(/Ă€|Ă|áº |áº¢|Ăƒ|Ă‚|áº¦|áº¤|áº¬|áº¨|áºª|Ä‚|áº°|áº®|áº¶|áº²|áº´/g, "A"), n = n.replace(/Ăˆ|Ă‰|áº¸|áºº|áº¼|Ă|á»€|áº¾|á»†|á»‚|á»„/g, "E"), n = n.replace(/ĂŒ|Ă|á»|á»ˆ|Ä¨/g, "I"), n = n.replace(/Ă’|Ă“|á»Œ|á»|Ă•|Ă”|á»’|á»|á»˜|á»”|á»–|Æ |á»œ|á»|á»¢|á»|á» /g, "O"), n = n.replace(/Ă™|Ă|á»¤|á»¦|Å¨|Æ¯|á»ª|á»¨|á»°|á»¬|á»®/g, "U"), n = n.replace(/á»²|Ă|á»´|á»¶|á»¸/g, "Y"), n = n.replace(/Ä/g, "D"), n = n.replace(/\u0300|\u0301|\u0303|\u0309|\u0323/g, ""), n = n.replace(/\u02C6|\u0306|\u031B/g, ""), n = n.replace(/ + /g, " "), n = n.trim(), n.replace(/!|@|%|\^|\*|\(|\)|\+|\=|\<|\>|\?|\/|,|\.|\:|\;|\'|\"|\&|\#|\[|\]|~|\$|_|`|-|{|}|\||\\/g, " ")
}

function slugify(n) {
    return n.toString().toLowerCase().replace(/Ă |Ă¡|áº¡|áº£|Ă£|Ă¢|áº§|áº¥|áº­|áº©|áº«|Äƒ|áº±|áº¯|áº·|áº³|áºµ/g, "a").replace(/Ă¨|Ă©|áº¹|áº»|áº½|Ăª|á»|áº¿|á»‡|á»ƒ|á»…/g, "e").replace(/Ă¬|Ă­|á»‹|á»‰|Ä©/g, "i").replace(/Ă²|Ă³|á»|á»|Ăµ|Ă´|á»“|á»‘|á»™|á»•|á»—|Æ¡|á»|á»›|á»£|á»Ÿ|á»¡/g, "o").replace(/Ă¹|Ăº|á»¥|á»§|Å©|Æ°|á»«|á»©|á»±|á»­|á»¯/g, "u").replace(/á»³|Ă½|á»µ|á»·|á»¹/g, "y").replace(/Ä‘/g, "d").replace(/!|@|%|\^|\*|\(|\)|\+|\=|\<|\>|\?|\/|,|\:|\;|\'|-|\"|\&|\#|\[|\]|~|$|_/g, "").replace(/\./g, "-").replace(/ /g, "-").replace(/\s+/g, "-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").replace(/^-+/, "").replace(/-+$/, "")
}
...
function GetDataInfor() {
    ...
    if (!isLoadData) {
        try {
            u = GetNamCookiesRunlive("DMX_Personal");
            let e = decodeURIComponent(getCookie(u));
            if (t = 3, i = 0, e != null && e !== "null" && e !== undefined && (n = JSON.parse(e), t = n != null && n != undefined ? n.ProvinceId : 0, i = n != null && n != undefined ? n.DistrictId : 0), f = GetNamCookiesRunlive("_mwgorhis"), r = getCookie(f), t == 3 && i == 0 && (r == undefined || r == "")) {
        ...
        $.ajax({
            ...
            success: function(n) {
                n != "" ? n.status == 0 || n.status == -1 ? ($(".header__address span").html(n.fullAdress), fullAddress = n.fullAdressPopup) : n.status == 1 && ($(".header__address span").html(n.fullAdress), fullAddress = n.fullAdressPopup, n.name != undefined && n.name != null && $(".header__history").html("ÄÆ¡n hĂ ng " + n.name.replace("(", "").replace(")", ""))) : $(".header__address span").html("Há»“ ChĂ­ Minh")
            },
            error: function() {},
            complete: function() {
...
function LoadPopupLocationV2() {
    IsLoadingPersonalize || subID == 4 || $.ajax({
        ...
        success: function(n) {
            var t, i, r;
            n != "" && (isLoadPopupLocation = !1, CheckLocationSuggest(), $(".locationbox__overlay").remove(), $(".locationbox-v2").remove(), $("#lc_pop--sugg").remove(), $("header").after(n), t = $("#hdLocationProvinceId").val(), t > 0 && $("#lst-prov li").length > 0 && ($("#lst-prov li a").removeClass("active"), $("#lst-prov li").find("a[data-value=" + t + "]").addClass("active")), i = $("#hdLocationDisId").val(), i > 0 && $("#lst-dis li").length > 0 && ($("#lst-dis li a").removeClass("active"), $("#lst-dis li").find("a[data-dis=" + i + "]").addClass("active")), r = $("#hdLocationWardId").val(), r > 0 && $("#lst-ward li").length > 0 && ($("#lst-ward li a").removeClass("active"), $("#lst-ward li").find("a[data-value=" + r + "]").addClass("active")), $(".topinstall .headinstall .headinfo .province").length > 0 && $(".topinstall .headinstall .headinfo .province").html($("#h-provincename").text()), callFirstLoadPopup(), backLocation(!0), $(".locationbox__overlay").show(), $(".locationbox-v2").show(), $("#lc_pop--sugg").remove(), $("html,body").toggleClass("over-flow"))
        },
        error: function() {},
        complete: function() {
            IsLoadingPersonalize = !1
...
function LoadViewedHistoryByCate(n) {
    return !1
}
                ...
                if (n.preventDefault(), !Summiting) {
                    ...
                    $.ajax({
                        ...
                        success: function(n) {
                            Summiting = !1;
                            $("#dldingtext").hide();
                            n.status > 0 && (hasSusses = !0, $("#global_form").addClass("form_success"), $("#global_form").html("<a href='javascript:OpenFeedbackGlobal()'>ÄĂ³ng<\/a><span>ChĂ¢n thĂ nh cáº£m Æ¡n Ă½ kiáº¿n Ä‘Ă³ng gĂ³p cá»§a quĂ½ khĂ¡ch!<span>"))
                        },
                        error: function() {
                            $("#dldingtext").hide()
                        }
...
function CheckButtonCompareCategory() {
    ...
    if (r !== "" && r !== null && r != undefined && (i = r.split(","), i != null && i.length > 0))
        for (u = 0; u < i.length; u++) {
            if (f = i[u], n = $(".listproduct *[data-id=" + f + "]").first(), n != undefined && n.length > 0 && n.find("a.item-ss") != undefined && n.find("a.item-ss").hasClass("active") == !1 && n.find("a.item-ss").addClass("active").html("<i><\/i> ÄĂ£ thĂªm so sĂ¡nh"), t = $(".compare-popup .pro-compare *[data-id=" + f + "]"), t != undefined && t.length > 0)
...
function changePoupProvinceV2(n, t, i = 0) {
    ...
    $.ajax({
        ...
        success: function(r) {
            r != "" && ($(t).addClass("active"), $("#hdLocationProvinceId").val(n), $("#lst-prov").addClass("hide").hide(), $("#lst-dis").html(r).removeClass("hide").show(), callTitleLocation(), i > 0 && $("#lst-dis li").find("a[data-dis=" + i + "]").click());
...
function getLocationCustomer() {
    ...
    let t = 0,
        ...
        e = "";
    try {
        let h = decodeURIComponent(getCookie("DMX_Personal"));
        o = window.location.hostname.indexOf("newstaging") > -1 || window.location.hostname.indexOf("localhost") > -1;
        s = window.location.hostname.indexOf("newsbeta") > -1;
        o && (h = decodeURIComponent(getCookie("DMX_Personal_Staging")));
        s && (h = decodeURIComponent(getCookie("DMX_Personal_Beta")));
        h != null && h !== "null" && h !== undefined && (n = JSON.parse(h), t = n != null && n != undefined ? n.ProvinceId : 0, u = n != null && n != undefined ? n.ProvinceName : "", i = n != null && n != undefined ? n.DistrictId : 0, f = n != null && n != undefined ? n.DistrictType + " " + n.DistrictName : "", r = n != null && n != undefined ? n.WardId : 0, e = n != null && n != undefined ? n.WardType + " " + n.WardName : "")
    } catch (h) {
        t = 0;
        i = 0;
        r = 0
...
function suggestLocation(n) {
    if (!searching) {
        searching = !0;
        n.preventDefault();
        var r = $("#locationSearch").val().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|_|-|\(|\)|{|}|\[|\]|\\|\|/gi, ""),
            i = r.trim().toString().toLowerCase(),
            t = $("#suggest-location");
        if (i.length < MIN_SSKEYWORD_LENGTH) {
            t.html("");
...
function gotoSuggestLocation(n) {
    ...
    u > 0 && i > 0 ? ($("#hdLocationProvinceId").val(t), $("#hdLocationDisId").val(i), $("#hdLocationWardId").val(u), locationConfirm()) : i > 0 && t > 0 ? changePoupProvinceV2(t, $("#lst-prov ul").find("a[data-value=" + t + "]"), i) : t > 0 && (backLocation(!0), changePoupProvinceV2(t, $("#lst-prov ul").find("a[data-value=" + t + "]")));
...
function resetPopupLocation() {
    ...
    getLocationCustomer().wardID > 0 ? ($(".top-location .default-title").addClass("hide").hide(), $(".top-location .full-location").removeClass("hide").show()) : ($(".top-location .default-title").removeClass("hide").show(), $(".top-location .full-location").addClass("hide").hide())
}

function callFirstLoadPopup() {
    getLocationCustomer().wardID > 0 ? ($("p.default-title").addClass("hide").hide(), $("p.full-location").removeClass("hide").show(), (fullAddress == "" || fullAddress == undefined) && (fullAddress = $("#lst-prov li a.active").length > 0 ? $("#lst-prov li a.active").text() : "Há»“ ChĂ­ Minh"), $(".fulladdress-v2").html(fullAddress)) : ($("p.default-title").removeClass("hide").show(), $("p.full-location").addClass("hide").hide())
}

function clearSearchBox() {
    $("input[name=locationSearch]").val("");
    $(".clear-searchbox").hide();
    var n = $.Event("keypress", {
        which: 13
    });
    suggestLocation(n)
}
...
function suggestSearch(n) {
    var i, t, r, u;
    if (n.preventDefault(), i = "#search-result", t = $("#skw").val(), $(".header__search .dropdownsearch").length > 0 ? (r = $(".header__search .dropdownsearch a").data("id"), r == 1 && (t = t.toString().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|\(|\)|{|}|\[|\]|\\|\|/gi, ""))) : t = t.toString().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|_|-|\(|\)|{|}|\[|\]|\\|\|/gi, ""), u = t.trim().toLowerCase(), u.length < MIN_SSKEYWORD_LENGTH) {
        $(i).html("");
        return
    }
...
function goToSearchPage(n, t) {
    ...
    else location.href.indexOf(".com/may-doi-tra") > 0 || location.href.indexOf("type=-2") > 0 ? i = "/tag/" + u + "?key=" + r + "&type=-2" : location.href.indexOf(".com/kinh-nghiem-hay") > 0 || location.href.indexOf("kinh-nghiem-hay") > 0 || location.href.indexOf("/khuyen-mai") > 0 ? i = "/tag-kinh-nghiem-hay/" + u + "?key=" + r : (i = "/tag/" + u + "?key=" + r, UpdateSearchKeywordHistory(h, urlRoot + i));
    location.href = i
}
var ConditionOperator, AutoComplete, globalEvent, laodBHX, isLoadPopupLocation, IsLoadingPersonalize, IsLoadingSuggest, keyViewedHistory, container, Summiting, bannerTopIndexKey, isRandomBannerTop;
! function(n, t) {
    "use strict";
...
AutoComplete = function() {
    ...
    return n.prototype.create = function(t, i) {
        ...
        return n.toLowerCase().replace(/Ă |Ă¡|áº¡|áº£|Ă£|Ă¢|áº§|áº¥|áº­|áº©|áº«|Äƒ|áº±|áº¯|áº·|áº³|áºµ/g, "a").replace(/Ă¨|Ă©|áº¹|áº»|áº½|Ăª|á»|áº¿|á»‡|á»ƒ|á»…/g, "e").replace(/Ă¬|Ă­|á»‹|á»‰|Ä©/g, "i").replace(/Ă²|Ă³|á»|á»|Ăµ|Ă´|á»“|á»‘|á»™|á»•|á»—|Æ¡|á»|á»›|á»£|á»Ÿ|á»¡/g, "o").replace(/Ă¹|Ăº|á»¥|á»§|Å©|Æ°|á»«|á»©|á»±|á»­|á»¯/g, "u").replace(/á»³|Ă½|á»µ|á»·|á»¹/g, "y").replace(/Ä‘/g, "d").replace(/!|@|%|\^|\*|\(|\)|\+|\=|\<|\>|\?|\/|,|\.|\:|\;|\'| |\"|\&|\#|\[|\]|~|$|_/g, "-").replace(/\s+/g, "-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").replace(/^-+/, "").replace(/-+$/, "")
    }, n.merge = function() {
...
$(document).ready(function() {
    ...
    if (OverrideRootUrl(urlRoot), ($(".header__search .dropdownsearch").length > 0 || $(".focused").length > 0) && (isHasSub = !0, subID = $("header.header").data("sub")), $(".showtaga").click(function() {
        ...
        }), GetDataInfor(), GetQuanatyCart(), $(".dmca-badge").length > 0 && (i = $(".dmca-badge").attr("href") + "&refurl=" + location.href, $(".dmca-badge").attr("href", i)), $(".banner-texttop ._left a").length > 0) {
